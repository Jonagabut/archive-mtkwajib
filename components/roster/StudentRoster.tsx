    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <motion.div
        ...
        <div className="flex justify-center pt-3">
          <div className="w-10 h-1 rounded-full mb-1" style={{ background: "var(--border)" }} />
        </div>
        <div className="relative w-full h-44 overflow-hidden">
          <Image src={student.photo_grad_url || PH_GRAD} alt={student.name}
      ...
      <motion.div
        ...
        <div className={`flip-card-inner ${flipped ? "flipped" : ""}`}>
          ...
          <div className="flip-card-front rounded-xl overflow-hidden group"
            ...
            <div className="relative w-full h-[188px] md:h-[242px] overflow-hidden"
            ...
            <div className="p-3" style={{ background: "var(--card)" }}>
              <h3 className="font-display text-sm md:text-base leading-tight truncate"
                style={{ color: "var(--ink)", fontStyle: "italic" }}>
                {student.name}
              </h3>
              <p className="font-mono text-[9px] md:text-[10px] mt-0.5 truncate"
            ...
            <div className="p-3 flex flex-col gap-2">
              ...
              {student.quote && (
                <div className="flex items-start gap-1.5">
                  ...
                  <p className="font-body text-[11px] leading-relaxed line-clamp-3"
